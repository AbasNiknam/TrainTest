...
figure(2)
subplot(2,2,1);
cm = confusionchart(T31',predicted_values_31);
title(' Actual Data (All - 4706): confusionchart ---> Column 31');

subplot(2,2,3);
cm = confusionchart(T31tst',predicted_values_31_tst);
title(' Test Data: confusionchart ---> Column 31');

subplot(2,2,2);
cm = confusionchart(T32',predicted_values_32);
title(' Actual Data (All - 4706): confusionchart ---> Column 32');
...
%% Save Result
filename = 'Result_Test_AllData.xlsx';
